...
# Feature toggles
FEATURE_ENABLE_ALERT_GROUP_SEARCH=getenv_boolean("FEATURE_ENABLE_ALERT_GROUP_SEARCH", default=True)
...
PHONE_PROVIDERS = {
    ...
    "mocloud":"apps.mocloud.mocloud_phone_provider.MOCloudPhoneProvider",
}
...
MOC_DEFAULT_ALERT_TEAM = os.getenv("MOC_DEFAULT_ALERT_TEAM", "other")

MOC_VMS_ALERT_PHONE_OPS = getenv_boolean("MOC_VMS_ALERT_PHONE_OPS", default=True)
MOC_DEFAULT_ALERT_OPS_TMPL = os.getenv("MOC_DEFAULT_ALERT_OPS_TMPL", "TTS_304405001")
MOC_DEFAULT_ALERT_CALLER = os.getenv("MOC_DEFAULT_ALERT_CALLER", "0571000014479")
